...
INSERT INTO MODEL VALUES (1, 'Sport', 'это «спортивная» версия модели «Лада Гранта»', 3, 1, 1, 0);
INSERT INTO MODEL VALUES (2, 'Grand Coupe', 'это седан, который выпускается с ноября 2019 года в Германии, на заводе в городе Лейпциге', 1, 2, 2, 0);
INSERT INTO MODEL VALUES (3, 'X', 'Девятое поколение автомобиля Mitsubishi Lancer', 2, 3, 3, 0);
INSERT INTO MODEL VALUES (4, 'VI', 'Спорткар Ford Mustang шестого поколения дебютировал на американском рынке в сентябре 2014 года, а в 2015 году автомобиль официально начали продавать в Европе — впервые в истории модели.', 4, 4, 4, 0);
INSERT INTO MODEL VALUES (5, 'V', 'Первый экземпляр Ford Mustang пятого поколения был выпущен в 2004 году.', 4, 4, 4, 0);
INSERT INTO MODEL VALUES (6, '1.6', 'Хендай Элантра — это четырёхдверный седан среднего класса, седьмое поколение которого выпускается в Корее с 2020 года.', 3, 5, 5, 0);
INSERT INTO MODEL VALUES (7, '1.4', 'Хендай Солярис — это компактный седан для российского рынка, выпускающийся на заводе в Санкт-Петербурге с февраля 2017 года.', 3, 5, 6, 0);
